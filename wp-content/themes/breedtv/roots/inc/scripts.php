...
function roots_scripts() {
  ...
  //LESS CSS
  wp_register_script('env_js', get_template_directory_uri() . '/js/env.js', false, null, false);
  wp_enqueue_script('env_js');
  wp_register_script('less_js', get_template_directory_uri() . '/js/less-1.3.0.min.js', false, null, false);
